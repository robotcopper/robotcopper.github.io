...
e.default=dt7948.p({setupComponent(e,t){t.setProperties({templatesVisible:!1,model:(0,s.getOwnerWithFallback)(this).lookup("service:composer").model}),this.appEvents.on("discourse-templates:show",this,"show"),this.appEvents.on("discourse-templates:hide",this,"hide")},teardownComponent(){this.appEvents.off("discourse-templates:show",this,"show"),this.appEvents.off("discourse-templates:hide",this,"hide")},shouldRender:(e,t)=>!t.site.mobileView,show(e){let{onInsertTemplate:t}=e
...
this.site.mobileView?this.#k(null,e):this.#C(e)}showTextAreaUI(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:document.activeElement
if(!this.#E(t))return
const s=document.querySelector(".d-modal"),o=this.#I.bind(this),i=t=>e?.(t)
...
return s&&o?.contains(e)}get isTextAreaFocused(){return this.#E(document.activeElement)}#E(e){return"TEXTAREA"===e?.nodeName}#k(e,t){this.dTemplatesModal.show({textarea:e,onInsertTemplate:t})}#C(e){this.appEvents.trigger("composer-messages:close"),this.appEvents.trigger("composer:show-preview"),this.appEvents.trigger("discourse-templates:show",{onInsertTemplate:e})}#I(e,s,i){s=this.#O(s.title,s.content,i),new o.default((0,t.getOwner)(this),{textarea:e}).insertBlock(s.content)}#M(e){const s=(0,t.getOwner)(this).lookup("service:composer").model,o=(0,a.default)(s)
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
e.default=(0,t.createTemplateFactory)({id:"7DOrvn3u",block:'[[[41,[30,0,["templatesVisible"]],[[[1,"  "],[10,0],[14,0,"d-templates-container"],[12],[1,"\\n    "],[8,[39,2],[[24,0,"modal-close close btn-flat"]],[["@action","@icon"],[[28,[37,3],[[30,0],"hide"],null],"xmark"]],null],[1,"\\n    "],[8,[39,4],null,[["@onInsertTemplate","@onAfterInsertTemplate"],[[30,0,["onInsertTemplate"]],[28,[37,3],[[30,0],"hide"],null]]],null],[1,"\\n  "],[13],[1,"\\n"]],[]],null]],[],false,["if","div","d-button","action","d-templates/filterable-list"]]',moduleName:"discourse/plugins/discourse-templates/discourse/templates/connectors/editor-preview/d-templates.hbs",isStrictMode:!1})})),define("discourse/plugins/discourse-templates/discourse/templates/connectors/topic-above-posts/discourse-templates-button",["exports","@ember/template-factory"],(function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
//# sourceMappingURL=discourse-templates-a7eaee64ad94168dd83cd194a35a1a8254f8e565ff2b8ae642c01b3ea402bf46.map
//!

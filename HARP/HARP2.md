...
<div style="display: flex; align-items: center; gap: 20px;overflow: hidden; max-width: 90%;" class="container_harp harp-nav">
  <img src="/config/assets/images/HARP/HARP2/HARP2_emblem2.png" class="harp-emblem" style="max-width: 250px; max-height: 250px; background-color: transparent; display: block; margin-left: 13%;">
...
<h2 id="overview-diagram" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-left: 10%;">Overview diagram</h2>
  <div style="display: flex; justify-content: center;">
      <img src="/config/assets/images/HARP/HARP2/HARP2_poster2.png" class="harp-poster" style="background: transparent; border-radius: 20px; width: 60%" >
  </div>
...
<h2 id="mechanics" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-right: 10%; text-align: -moz-right;">Mechanics</h2>
  ...
  <div style="display: flex; align-items: center; gap: 20px;overflow: hidden;" class="container_harp harp-block">
    ...
    <img src="/config/assets/images/HARP/HARP2/Harp2_meca.jpg" class="harp-shot" style="max-width: 350px; max-height: 250px; background-color: transparent; display: block; border-radius: 7px;">
  </div>
...
<h2 id="micro-controller" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-left: 10%;">Micro Controller and micro-ROS</h2>
  ...
  <div style="display: flex; align-items: center; gap: 20px;overflow: hidden;" class="container_harp harp-block">
    ...
    <img src="/config/assets/images/HARP/HARP2/picoxuros.png" class="harp-shot harp-shot--mark" style="max-width: 300px; max-height: 250px; background-color: transparent; display: block; border-radius: 7px;">
  </div>

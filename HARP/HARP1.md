...
<div class="harp-match-banner" style="display: flex; flex-wrap: wrap; align-items: stretch; background-color: #f0d95c; padding: 10px; border-radius: 10px; font-family: Arial, sans-serif; color: #000; max-width: 92%; box-sizing: border-box; margin: 0 auto; position: relative; overflow: hidden;">
    <!-- Horn effect -->
    ...
    <!-- Video section -->
    <div class="harp-match-video" style="flex: 1 1 35%; min-width: 280px; display: flex; align-items: stretch;">
...
<div style="display: flex; align-items: center; gap: 20px;overflow: hidden; max-width: 90%;" class="container_harp harp-nav">
  <img src="/config/assets/images/HARP/HARP1/HARP1_emblem.png" class="harp-emblem" style="max-width: 250px; max-height: 250px; background-color: transparent; display: block; margin-left: 13%;">
...
<h2 id="overview-diagram" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-left: 10%;">Overview diagram</h2>
  <div style="display: flex; justify-content: center;">
      <img src="/config/assets/images/HARP/HARP1/HARP1_poster.png" class="harp-poster" style="background: transparent; border-radius: 20px; width: 50%" >
  </div>
...
<h2 id="mechanics" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-right: 10%; text-align: -moz-right;">Mechanics</h2>
  ...
  <div style="display: flex; align-items: center; gap: 20px;overflow: hidden;" class="container_harp harp-block">
    <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 12px;">
    ...
    <img src="/config/assets/images/HARP/HARP1/Harp1_meca.png" class="harp-shot" style="max-width: 350px; max-height: 250px; background-color: transparent; display: block; border-radius: 7px;">
  </div>
...
<h2 id="electronics" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-left: 10%;">Electronics</h2>
  ...
  <div style="display: flex; align-items: center; gap: 20px; overflow: hidden; max-width: 85%; margin-left: 7%;" class="container_harp harp-block">
    <div class="harp-media-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 0px; max-width: 18%; max-height: 18%; border-radius: 3px; overflow: hidden;">
...
<h2 id="micro-controller" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-left: 10%;">Micro Controller and Rosserial</h2>
  ...
  <div style="display: flex; align-items: center; gap: 20px;overflow: hidden;" class="container_harp harp-block">
    ...
    <img src="/config/assets/images/HARP/HARP1/arduinoxrosserial.png" class="harp-shot harp-shot--mark" style="max-width: 350px; max-height: 250px; background-color: transparent; display: block; border-radius: 7px;">
  </div>
...
<h2 id="ros" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-right: 10%; text-align: -moz-right;">ROS (Robot Operating System)</h2>
  <div style="display: flex; align-items: center; gap: 20px;overflow: hidden;" class="container_harp harp-block">
    <img src="/config/assets/images/HARP/HARP1/ros_logo.png" class="harp-shot harp-shot--mark" style="max-width: 350px; max-height: 250px; background-color: transparent; display: block; border-radius: 12px;">
    <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 12px;">
...
<h2 id="actuator" style="line-height: 1.2; border-bottom: 1.5px solid #00AAA3; margin-left: 10%;">Actuator</h2>
  <div style="display: flex; align-items: center; gap: 20px;overflow: hidden;" class="container_harp harp-block">
    ...
    <img src="/config/assets/images/HARP/HARP1/actuator.gif" class="harp-shot" style="max-width: 350px; max-height: 250px; background-color: transparent; display: block; border-radius: 12px;">
  </div>